    ...
    <main>
      {user && (
        <div className="text-white min-h-screen">
          ...
          <p className="font-poppins-bold uppercase text-center mt-4 m-2 text-lg">
            {user.name}
          </p>
          ...
          <div className="flex gap-4 flex-wrap justify-center mb-4">
            ...
            {/* <button onClick={() => console.log(session)}>gyatt button</button> */}
          </div>
          
          {(session?.user?.name === user.username && user.role == "teacher") && (
          ...
          {(session?.user?.name === user.username && user.role == "student") && (
